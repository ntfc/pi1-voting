...
public class JVoterMain extends javax.swing.JFrame {
  ...
  private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    if(voting instanceof YesNoVoting) {
      ...
      try {
        if(((JCheckBox)options[0]).isSelected()) {
          b = voting.createBallot(voter.getPublicKey(), 0);
        }
        else {
          b = voting.createBallot(voter.getPublicKey(), 1);
        }
        this.voter.submitBallot(b);
      }
      catch(Exception ex) {
        JOptionPane.showMessageDialog(this, ex.getMessage());
    ...
    else if(voting instanceof KOutOfLVoting) {
